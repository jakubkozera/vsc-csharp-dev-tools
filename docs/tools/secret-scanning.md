...
Configure scanning behavior through VS Code settings:

```json
{
  "csharp-dev-tools.secretScanning.includeGitHistory": true,
  "csharp-dev-tools.secretScanning.maxFileSizeKB": 1024,
  "csharp-dev-tools.secretScanning.excludePatterns": [
    "**/node_modules/**",
    "**/bin/**",
    "**/obj/**"
  ]
...
```json
{
  "csharp-dev-tools.secretScanning.customPatterns": [
    {
      "name": "Custom API Key",
...
- Automated blocking of suspicious commits

**Branch Protection**
- Configure branch protection rules
- Require secret scanning for pull requests
...
- PDF reports for security audits
...
- Exclude binary files and dependencies
...
2. Review VS Code Developer Tools console
3. File issues on the extension repository
4. Consult TruffleHog documentation for advanced usage

## Best Practices Summary

✅ **Do:**
- Run scans regularly as part of your workflow
- Review all findings carefully before ignoring
- Use proper secret management solutions
- Educate your team on security practices
- Integrate scanning into CI/CD pipelines

❌ **Don't:**
- Ignore security findings without proper review
- Commit secrets to version control
- Use hardcoded credentials in production
- Skip scanning in shared repositories
- Disable scanning without security team approval
